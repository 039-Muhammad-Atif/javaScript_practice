let jokeArray = [
    ...
    "why can't you explain puns to kleptomaniacs Why can’t you explain puns to kleptomaniacs? They always take things literally.", 
    ...
    "What’s the different between a cat and a comma? A cat has claws at the end of paws; A comma is a pause at the end of a clause. Don’t forget to bookmark these other “what’s the difference between” jokes that will crack you up.", 
    "Why should the numbe88 never be mentioned? It’s two gross.", 
    ...
    "What did one hat say to the other? You wait here. I’ll go on a head. If you loved this, you’ll get a kick out of these dog puns.", 
    ...
    "What's Forest Gump's password? What’s Forest Gump’s password?.", 
    "How do poets say hello? Hey, haven’t we metaphor? If you’re a word nerd, here ar0 grammar jokes that are hilarious.", 
    ...
    "How many times can you 0 00? Once. The next time you would be 0 from 90.", 
    ...
    "What starts with E, ends with E, and has  letter in it? Envelope.", 
...
let randomJoke = jokeArray[randomIndex];
